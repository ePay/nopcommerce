...
namespace Nop.Plugin.Payments.EPay.dk.ditonlinebetalingssystem.ssl {
    using System;
    ...
    public partial class Payment : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Payment() {
            this.Url = global::Nop.Plugin.Payments.EPay.Properties.Settings.Default.Nop_Plugin_Payments_ePay_dk_ditonlinebetalingssystem_ssl_Payment;
        ...
        /// <remarks/>
        public event movetransactiontogroupCompletedEventHandler movetransactiontogroupCompleted;
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("https://ssl.ditonlinebetalingssystem.dk/remote/payment/movetransactiontogroup", RequestNamespace="https://ssl.ditonlinebetalingssystem.dk/remote/payment", ResponseNamespace="https://ssl.ditonlinebetalingssystem.dk/remote/payment", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public bool movetransactiontogroup(int merchantnumber, long transactionid, string group, string pwd, ref int epayresponse) {
            object[] results = this.Invoke("movetransactiontogroup", new object[] {
                        merchantnumber,
                        transactionid,
                        group,
                        pwd,
        ...
        /// <remarks/>
        public void movetransactiontogroupAsync(int merchantnumber, long transactionid, string group, string pwd, int epayresponse) {
            this.movetransactiontogroupAsync(merchantnumber, transactionid, group, pwd, epayresponse, null);
        }
        
        /// <remarks/>
        public void movetransactiontogroupAsync(int merchantnumber, long transactionid, string group, string pwd, int epayresponse, object userState) {
            if ((this.movetransactiontogroupOperationCompleted == null)) {
                this.movetransactiontogroupOperationCompleted = new System.Threading.SendOrPostCallback(this.OnmovetransactiontogroupOperationCompleted);
            }
            this.InvokeAsync("movetransactiontogroup", new object[] {
                        merchantnumber,
                        transactionid,
                        group,
                        pwd,
                        epayresponse}, this.movetransactiontogroupOperationCompleted, userState);
        }
        
        private void OnmovetransactiontogroupOperationCompleted(object arg) {
            if ((this.movetransactiontogroupCompleted != null)) {
                System.Web.Services.Protocols.InvokeCompletedEventArgs invokeArgs = ((System.Web.Services.Protocols.InvokeCompletedEventArgs)(arg));
                this.movetransactiontogroupCompleted(this, new movetransactiontogroupCompletedEventArgs(invokeArgs.Results, invokeArgs.Error, invokeArgs.Cancelled, invokeArgs.UserState));
            }
        }
    ...
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    public delegate void movetransactiontogroupCompletedEventHandler(object sender, movetransactiontogroupCompletedEventArgs e);
    
    /// <remarks/>
    [System.CodeDom.Compiler.GeneratedCodeAttribute("System.Web.Services", "4.0.30319.17929")]
    [System.Diagnostics.DebuggerStepThroughAttribute()]
    [System.ComponentModel.DesignerCategoryAttribute("code")]
    public partial class movetransactiontogroupCompletedEventArgs : System.ComponentModel.AsyncCompletedEventArgs {
        
        private object[] results;
        
        internal movetransactiontogroupCompletedEventArgs(object[] results, System.Exception exception, bool cancelled, object userState) : 
                base(exception, cancelled, userState) {
            this.results = results;
        }
