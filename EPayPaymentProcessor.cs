...
using Nop.Plugin.Payments.EPay.epay.subscriptionservice;
...
namespace Nop.Plugin.Payments.EPay
{
    ...
    public class EPayPaymentProcessor : BasePlugin, IPaymentMethod
    {
        ...
        {
            EPayPaymentSettings settings = new EPayPaymentSettings
            {
        ...
        {
            get { return ePayPaymentSettings.UseRemoteInterface; }
        }
        ...
        {
            get { return ePayPaymentSettings.UseRemoteInterface ? RecurringPaymentType.Manual : RecurringPaymentType.NotSupported; }
        }
